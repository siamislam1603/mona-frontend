...
function OwnFormResponse(props) {
  ...
  educatorChildren && console.log('EDUCATOR CHILDREN>>>>>>>>>>>>>>>>>', educatorChildren);
  return (
    <>
      <div id="main">
        <ToastContainer />
                      ...
                      {responseData.map((item, index) => {
                        ...
                        return localStorage.getItem('user_role') ===
                          ...
                          localStorage.getItem('user_role') === 'educator'
                            ? (
                              (educatorChildren.includes(item[0].user.fullname) || (parseInt(item[0].user_id) === parseInt(localStorage.getItem('user_id')))) &&
                              <Accordion.Item key={index} eventKey={index}>
                                <Accordion.Header>
                                  <div className="responses-header-row">
                                    <div className="responses-header-left">
